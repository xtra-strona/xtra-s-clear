...
<script src="<?php bloginfo('template_directory'); ?>/inc/c-f-s/assets/js/fields.js"></script>
<script src="<?php bloginfo('template_directory'); ?>/inc/c-f-s/assets/js/select2/select2.min.js"></script>
<script src="<?php bloginfo('template_directory'); ?>/inc/c-f-s/assets/js/jquery-powertip/jquery.powertip.min.js"></script>
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/inc/c-f-s/assets/css/fields.css" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/inc/c-f-s/assets/js/select2/select2.css" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/inc/c-f-s/assets/js/jquery-powertip/jquery.powertip.css" />
